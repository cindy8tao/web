  ...
  return (
    <div name='home' className='w-full h-screen background'>
      ...
      <div className='max-w-[1000px] mx-auto px-8 flex flex-col justify-center h-full relative'>
        <div className='z-10'>
          <h1 className='text-2xl text-gray-600 mt-10 sm:text-4xl'>
            Hi there, my name is
          </h1>
          <h1 className='text-4xl sm:text-6xl font-bold text-[#5085A5]'>
            CINDY TAO
          </h1>
          <h2 className='text-3xl sm:text-4xl font-bold text-[#8FC1E3]'>
            I'm a
          </h2>
          <div className='flex flex-col sm:flex-row'>
            <div className='flex-1'>
              <h2 className='text-2xl sm:text-3xl font-bold text-[#E27D60]'>
                <Typewriter
                  options={{
              ...
              <div className="flex flex-col sm:flex-row items-start sm:items-center">
                <button className="text-black group border-2 px-6 py-3 my-2 sm:mr-3 flex items-center hover:bg-[#E27D60] hover:border-[#E27D60]">
            ...
            <img src={self1} alt='Self 1' className='ml-4 w-[250px] h-[500px]' />
          </div>
        </div>
      </div>
    </div>
